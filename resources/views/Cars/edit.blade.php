...
@section('content')
    ...
    <div class="w-[600px] shadow-lg shadow-gray-500 rounded-xl mt-10 py-8 px-10">
        <form
            class=""
            method='post' enctype="multipart/form-data" action="{{route('cars.update', $car->id)}}">
            @csrf
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-2xl font-semibold text-blue-500 text-center border-b-2 pb-4">Edit car</h2>

                    <div class="mt-10 grid grid-cols-2 gap-x-6 gap-y-8 ">
                        <div class="sm:col-span-1">
                            <label for="brand"
                                   class="block text-sm/6 font-medium text-gray-900">Brand</label>
                            <div class="mt-2">
                                <div
